...
def main():
    ...
    st.markdown("""
        <div style=' padding: 1rem; border-radius: 0.5rem; margin-bottom: 2rem;'>
    ...
    if gemini_api_key:
        ...
        with col1:
            ...
            height = st.number_input("Height (ft)", min_value=3.0, max_value=8.0, step=0.1)
            ...
            dietary_preferences = st.selectbox(
                "Dietary Preferences",
                options=["Vegetarian", "Keto", "Gluten Free", "Low Carb", "Dairy Free",'None'],
